...
// end include: /tmp/tmplamm_oll.js
// include: /tmp/tmpz2300taw.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpz2300taw.js
// include: /tmp/tmp1k9o42xq.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp1k9o42xq.js
...
var ASM_CONSTS = {
  412742: () => { if (document.fullscreenElement) return 1; },  
 412788: () => { return Module.canvas.width; },  
 412820: () => { return parseInt(Module.canvas.style.width); },  
 412868: () => { document.exitFullscreen(); },  
 412895: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 412967: () => { if (document.fullscreenElement) return 1; },  
 413013: () => { return Module.canvas.width; },  
 413045: () => { return screen.width; },  
 413070: () => { document.exitFullscreen(); },  
 413097: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 413291: () => { return window.innerWidth; },  
 413317: () => { return window.innerHeight; },  
 413344: () => { if (document.fullscreenElement) return 1; },  
 413390: () => { return Module.canvas.width; },  
 413422: () => { return parseInt(Module.canvas.style.width); },  
 413470: () => { if (document.fullscreenElement) return 1; },  
 413516: () => { return Module.canvas.width; },  
 413548: () => { return screen.width; },  
 413573: () => { return window.innerWidth; },  
 413599: () => { return window.innerHeight; },  
 413626: () => { if (document.fullscreenElement) return 1; },  
 413672: () => { return Module.canvas.width; },  
 413704: () => { return screen.width; },  
 413729: () => { document.exitFullscreen(); },  
 413756: () => { if (document.fullscreenElement) return 1; },  
 413802: () => { return Module.canvas.width; },  
 413834: () => { return parseInt(Module.canvas.style.width); },  
 413882: () => { document.exitFullscreen(); },  
 413909: ($0) => { Module.canvas.style.opacity = $0; },  
 413947: () => { return screen.width; },  
 413972: () => { return screen.height; },  
 413998: () => { return window.screenX; },  
 414025: () => { return window.screenY; },  
 414052: () => { return window.devicePixelRatio; },  
 414088: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 414141: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 414192: () => { Module.canvas.style.cursor = 'none'; },  
 414229: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 414485: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 414536: () => { if (document.pointerLockElement) return 1; },  
 414583: () => { if (document.fullscreenElement) return 1; },  
 414629: () => { return window.innerWidth; },  
 414655: () => { return window.innerHeight; }
};
